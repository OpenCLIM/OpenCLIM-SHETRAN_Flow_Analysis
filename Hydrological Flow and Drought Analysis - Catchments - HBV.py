...
python "Hydrological Flow and Drought Analysis - Catchments - HBV.py" REM 'add any comment you want here'
...
# Set the path to the Historical Discharges:
...
# --- Set model type:
model = "HBV"  # "SHETRAN" | "HBV"
model_tab_name = "HBV"  # 'HBV' | 'SHETRAN-UK Autocalibrated' | 'SHETRAN-UK'

# --- Set model paths:

# # HBV Autocalibration Baseline:
# output_root_name = "01c_UKCP18_UDMbaseline"
# master_folder_UKCP18 = convex + "08_Analysis/00 - HBV Outputs for Analysis/Final Models - Monthly Means/outputUDMcat/outputUDMcat/UK/bc"  # UDM_newBC/UDMbc
# UDM_Folder_name = 'Base'

# # HBV Calibrated UKCP18 NFM Max:
# output_root_name = "02c_UKCP18_UDMbaseline_NFMmax"
# master_folder_UKCP18 = convex + "08_Analysis/00 - HBV Outputs for Analysis/Final Models - Monthly Means/outputNFMcatMax/UK/bc"  # /HBV Outputs for Analysis/HBV_02_NFM_max/NFM_max/bc"
# UDM_Folder_name = 'Base'

# # SHETRAN Calibrated UKCP18 NFM Bal (06c):
# output_root_name = "06c_UKCP18_UDMbaseline_NFMbal"
# master_folder_UKCP18 = convex + "08_Analysis/00 - HBV Outputs for Analysis/Final Models - Monthly Means/outputNFMcatMod/UK/bc"
# UDM_Folder_name = 'Base'

# UDM:
# master_folder_UKCP18 = convex + "08_Analysis/00 - HBV Outputs for Analysis/Final Models - Monthly Means/outputUDMcat/outputUDMcat/UK/bc"

# # >> Calibrated UKCP18 (03 SSP2 2050):
# output_root_name = "03d_UKCP18_UDM_ssp2_2050"
# UDM_Folder_name = 'ssp2_2050_default'

# # >> Calibrated UKCP18 (03 SSP2 2080):
# output_root_name = "03d_UKCP18_UDM_ssp2_2080"
# UDM_Folder_name = 'ssp2_2080_default'

# # >> Calibrated UKCP18 (03 SSP4 2050):
# output_root_name = "03d_UKCP18_UDM_ssp4_2050"
# UDM_Folder_name = 'ssp4_2050_default'

# # >> Calibrated UKCP18 (03 SSP4 2080):
# output_root_name = "03d_UKCP18_UDM_ssp4_2080"
# UDM_Folder_name = 'ssp4_2080_default'
...
if calculate_flow_stats:
    ...
    for catchment in catchment_list:
        ...
        try:  # Try/Exception used to account for missing files.
            path = master_folder_historical + str(catchment) + ".dat"
            sim_df = pd.read_csv(path, header=None, delim_whitespace=True, usecols=[3]).squeeze()
...
for catchment in catchment_list:
    ...
    for r in range(len(rcm_list)):
        ...
        try:
            # flow_path = f"{master_folder_UKCP18}{rcm}/bc{rcm}/{UDM_Folder_name}/SIMULATED/STANDARD/DISCHARGE/{str(catchment)}.dat"
            flow_path = f"{master_folder_UKCP18}{rcm}/{UDM_Folder_name}/SIMULATED/STANDARD/DISCHARGE/{str(catchment)}.dat"
            

            if os.path.exists(flow_path):
                flow_df = pd.read_csv(flow_path, header=None, delim_whitespace=True, usecols=[3]).squeeze()
